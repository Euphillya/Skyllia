...
public final class SQLitePermissionIndexStore implements PermissionIndexStore {

    private final DatabaseLoader databaseLoader;

    private final String SELECT_IDX = "SELECT idx FROM permission_registry WHERE node = ?;";
    private final String INSERT_NODE = "INSERT OR IGNORE INTO permission_registry (node) VALUES (?);";

    public SQLitePermissionIndexStore(DatabaseLoader databaseLoader) {
