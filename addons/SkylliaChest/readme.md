...
d’îles personnalisés, persistant et entièrement intégré à l’écosystème Skyblock.

Ce module permet à chaque île de disposer d’un inventaire partagé, accessible via commande, interface graphique et
